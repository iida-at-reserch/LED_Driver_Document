...
\subsection{どうやって自由自在にLEDに流れる電流をコントロールしているのか？}
...
\subsubsection{発振とは？}
　負帰還増幅回路における（異常）発振とは、信号がフィードバックループ内で有限時間内に減衰せず、持続的に循環し続ける現象指す。
%本来、
DR-CY-140で実際に発振が発生している様子を図　に示す。電流出力端子からは〇mの照明ケーブルを介して照明に接続されている。
このとき、目標値は　としているが、
